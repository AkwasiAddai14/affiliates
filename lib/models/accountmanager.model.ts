...
export interface IActivity {
    type: ActivityType;
    description: string;
    metadata?: Record<string, unknown>; // e.g. { leadId, companyName }
    createdAt: Date;
}
...
const accountManagerSchema = new Schema<IAccountManager>({
    ...
    // Activiteiten (chronologisch, nieuwste eerst bij lezen)
    activities: [{
...
// Optioneel: cap activities in application code (bijv. laatste 200) om documentgrootte te beperken
